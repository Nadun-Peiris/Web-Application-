...
<body>
    ...
    <section class="hero">
        ...
        <button onclick="location.href='<%= request.getContextPath() %>/moviedetails.jsp'">Book Now</button>
    </section>
    ...
    <section class="now-showing">
        ...
        <div class="movie-grid">
            <%
                ...
                String[] movieTitles = {"Gladiator II", "Movie Title 2", "Movie Title 3", "Movie Title 4"};
                String[] movieImages = {"Movie01.jpg", "movie4.webp", "Movie03.jpg", "Movie04.jpg"}; // Add movie images
            ...
            <div class="movie-card">
                ...
                <div class="movie-info">
                    <h3><%= movieTitles[i] %></h3>
                    <a href="<%= request.getContextPath() %>/moviedetails.jsp?movie=<%= movieTitles[i] %>">Book Now</a>
                </div>
            </div>
            <% } %>
        </div>
